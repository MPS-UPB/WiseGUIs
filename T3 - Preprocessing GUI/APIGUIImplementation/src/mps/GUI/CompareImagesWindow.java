...
public final class CompareImagesWindow extends JFrame {
	...
	public CompareImagesWindow(String imageFile1, String imageFile2)
		...
		// Bucata de cod pentru constructia de imagini tiff pentru
		// backgroundImage
		width = 250;
		height = 250;
		image = ImageViewer.buildImage(imageFile2);
		...
		l1.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent arg0) {
				// if compare button was pressed, none of the images are
				// selected
		...
		buttonsPanel.setBorder(BorderFactory.createMatteBorder(2, 1, 1, 1,
				Color.GRAY));
